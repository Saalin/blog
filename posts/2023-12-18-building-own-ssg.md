...
I haven't created layout by myself, it's [Jekyll Theme Console](https://github.com/b2a3e8/jekyll-theme-console) that I've adapted to my needs.
...
It's not generic, I won't recommend using it anywhere else. The only things that are missing for my use case are multi-language support (as I want to write some things in Polish) and tags support. Probably it will mean code refactor in the meantime, now it's rather big ball of mud than properly written piece of code (even though with about 100 lines of code it's easy to understand). Also, I probably need to look a bit at SSO related things.

## Was it worth?

Definitely. In less than 100 LoC I have everything I need and I have full control of it. I doubt I could have learnt new tool, such as existing SSG, with less time and effort.